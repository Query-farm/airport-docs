...
For detailed JSON format specification, see the [Airport Extension documentation](https://airport.query.farm/server_predicate_pushdown.html).
...
| [filter](https://github.com/hugr-lab/airport-go/tree/main/examples/filter) | Filter pushdown parsing and SQL encoding |
