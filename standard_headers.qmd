...
|-------------|---------------|-------------|
| `airport-user-agent` | `airport/20240820-02` | A user agent identifier that includes some verison information.  The format of this user agent string is free form |
