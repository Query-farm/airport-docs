...
Building the extension will build all of its dependencies, `protobuf`, `grpc`, `arrow` and others, this can take some time depending on the resources of the system being used to build the extension.
