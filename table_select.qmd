...
To fetch data from a flight, the Airport extension performs a `DoAction` RPC call named `endpoints`, instead of the standard `GetFlightInfo` RPC call. This is done because:
