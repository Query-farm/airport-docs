...
The Airport extension supports the `RETURNING` clause in `INSERT` statements. This feature allows the `INSERT` statement to return the rows that were inserted, after being processed by the server.
