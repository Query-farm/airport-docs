...
The **Airport extension** for DuckDB enables a powerful *Data-as-a-Service* (DaaS) model.
...
4. **Data Store**
    - The source of the data. Arrow Flight can:
      1. Stream data directly via Arrow IPC.
      2. Return a reference (e.g., URL to Parquet or CSV on a CDN).
...
1. **Authentication & Authorization**
    - Validate requests and enforce access rules. Optional row-level filtering is possible.
