...
The Airport extension issues a `DoAction` Arrow Flight RPC call with the action name `get_catalog_version`, passing the target catalog's name as a single parameter.
