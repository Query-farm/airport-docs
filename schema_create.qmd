...
The Airport extension supports the creation of schemas in the database it manages. DuckDB schemas can contain tables, functions, macros and other objects. The Arrow Flight server determines whether to create the schema.
