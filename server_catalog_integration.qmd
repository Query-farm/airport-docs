...
description: "Understand how Arrow Flight servers integrate with DuckDB's catalog system to make remote data appear as native tables, schemas, and functions."
filters:
  - d2
d2:
  layout: elk
