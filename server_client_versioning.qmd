...
description: "Ensure compatibility between Airport extension and Arrow Flight servers using the airport-user-agent header for protocol version negotiation."
---
