...
The Airport extension allows tables that it manages to have rows deleted.  The Arrow Flight server is responsible for deleting the data if it chooses to do so.
