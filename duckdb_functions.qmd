...
The Airport Extension supplies a number of functions to DuckDB.
...
::: {.callout-tip}
Calling these functions are considered a lower level interface to Airport.  Airport also [integrates with the DuckDB catalog](catalog_integration.qmd) the allows Arrow Flights to operate much like DuckDB Tables.
:::
