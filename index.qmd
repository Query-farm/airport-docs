...
<img src="https://duckdb.org/images/logo-dl/DuckDB_Logo-stacked.png" style="float:right" width="100px" alt="DuckDB Logo"/>
...
Airport is an extension written in C++ for DuckDB version 1.2.0 or later, it utilizes the Apache Arrow library.
