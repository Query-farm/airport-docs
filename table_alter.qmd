...
The Airport extension supports altering tables. The Arrow Flight server determines whether to apply the alteration.
...
All actions are not expected to return a value, but should raise an exception upon error.
