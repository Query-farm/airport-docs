...
This `table_function_flight_info` action is used to determine the schema of a table function supplied by an Arrow Flight Server.  Since table functions can be dynamic based on their parameters, this action is called with the parameters passed to the table function.
