...
The Airport extension allows tables that it manages to be updated.  The Arrow Flight server is responsible for storing and persisting the updated data if it chooses to do so.
